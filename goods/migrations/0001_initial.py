# Generated by Django 4.2.10 on 2024-02-28 09:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount', models.DecimalField(decimal_places=0, default=0.0, max_digits=2, verbose_name='Скидка %')),
                ('quantity', models.PositiveIntegerField(default=0, verbose_name='Количество')),
                ('cat', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='goods.category', verbose_name='Категория')),
            ],
            options={
